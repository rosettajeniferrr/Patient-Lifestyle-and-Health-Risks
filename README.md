...
- Work Type
- Residence Type
- Other lifestyle-related attributes
...
---
## 📌 Key Insights
- Individuals were grouped into distinct clusters based on lifestyle and health patterns.
- One cluster represents high-risk individuals with poor lifestyle habits (high BMI, low activity, etc.).
- Another cluster shows healthy individuals with balanced lifestyle behaviors.
- A moderate cluster indicates individuals who may require preventive care.
- Lifestyle factors collectively have a strong influence on overall health risk.
---
## 🚀 How to Run
- Download the dataset and notebook file
